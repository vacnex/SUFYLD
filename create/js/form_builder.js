    ...
    function getPreview(plain_html = '') {
        ...
        el.each(function () {
            ...
            if (data_type === 'text') {
                ...
                html += '<div class="input-field"><label for="input">' + label + '</label><input id="input" type="text" name="' + name + '" placeholder="' + placeholder + '" class="validate" ' + required + '/></div>';
            }
            if (data_type === 'number') {
                var placeholder = $(this).find('.form_input_placeholder').val();
                var checkbox = $(this).find('.form-check-input');
                ...
                html += '<div class="md-form"><label class="control-label" for="numberExample">' + label + '</label><input id="numberExample" type="number" name="' + name + '" placeholder="' + placeholder + '" class="form-control" ' + required + '/></div>';
            }
            if (data_type === 'email') {
                var placeholder = $(this).find('.form_input_placeholder').val();
                var checkbox = $(this).find('.form-check-input');
                ...
                html += '<div class="md-form"><i class="fas fa-envelope prefix"></i><label class="control-label" for="inputIconEx1">' + label + '</label><input id="inputIconEx1" type="email" name="' + name + '" placeholder="' + placeholder + '" class="form-control" ' + required + '/></div>';
            }
